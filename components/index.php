    ...
    <head>
        ...
        <body>
            <header>
                <div>  
                <a href="../home/"><img id="main-image" src="../images/logo-full.png" alt="logo"></a>
               </div>
            <form action="">
                <div class="search">
        ...
        <div class="header">
        <img src="../images/compo.jpg" class="header-image" alt="" width="100%">
        ...
        <footer>
            <p>&copy; 2023 Build Wizard. All rights reserved.</p>
        </footer>
    </body>
    </html>
