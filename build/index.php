<?php
    ...
    <div class="container mt-5">
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                    ...
                    <div class="form-group">
                        ...
                        <select class="custom-select custom-dropdown" id="cpu" name="cpu">
                    ...
                    <div class="form-group">
                        ...
                        <select class="custom-select custom-dropdown" id="motherboard" name="motherboard">
                            <option value="">Select</option>
                            <?php foreach($products as $product)
                            {
                    ...
                    <div class="form-group">
                        ...
                        <select class="custom-select custom-dropdown" id="cooler" name="cooler">
                        <option value="">Select</option>
                        <?php foreach($products as $product)
                            {
                    ...
                    <div class="form-group">
                        ...
                        <select class="custom-select custom-dropdown" id="ram" name="ram">
                            <option value="">Select</option>
                            <?php foreach($products as $product)
                            {
            ...
            <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <select class="custom-select custom-dropdown" id="gpu" name="gpu">
                            <option value="">Select</option>
                            <?php foreach($products as $product)
                            {
                    ...
                    <div class="form-group">
                        ...
                        <select class="custom-select custom-dropdown" id="storage" name="storage">
                            <option value="">Select</option>
                            <?php foreach($products as $product)
                            {
                    ...
                    <div class="form-group">
                        ...
                        <select class="custom-select custom-dropdown" id="psu" name="psu">
                            <option value="">Select</option>
                            <?php foreach($products as $product)
                            {
                    ...
                    <div class="form-group">
                        ...
                        <select class="custom-select custom-dropdown" id="case" name="case">
                            <option value="">Select</option>
                            <?php foreach($products as $product)
                            {
        ...
        <div class="text-center">
            ...
            {
            echo '<button type="submit" class="btn custom-button">Submit</button>';
            }?>
        </div>
        <br>
    </div>
